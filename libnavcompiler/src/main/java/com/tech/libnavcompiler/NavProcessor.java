package com.tech.libnavcompiler;
...
@SupportedAnnotationTypes({"com.tech.libnavannotation.ActivityDestination", "com.tech.libnavannotation.FragmentDestination"})
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        if (!fragmentElements.isEmpty() || !activityElements.isEmpty()) {
            ...
            try {
                ...
                String appPath = resourcePath.substring(0, resourcePath.indexOf("pda-master") + 4);
