...
import com.step.fastpda.databinding.LayoutRefreshView2Binding;
import com.tech.libcommon.extention.ItemTouchHelperCallback;
import com.tech.libcommon.view.EmptyView;

import java.lang.reflect.ParameterizedType;
import java.lang.reflect.Type;

public abstract class AbsListFragment2<T, M extends AbsViewModel<T>> extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    protected LayoutRefreshView2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = LayoutRefreshView2Binding.inflate(inflater, container, false);
